{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-9ca8726f-5e70-482e-a9c2-3089300ef0c8" = [ ];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."9ca8726f-5e70-482e-a9c2-3089300ef0c8".value = "Default";
      "kactivitymanagerdrc"."main"."currentActivity".value = "9ca8726f-5e70-482e-a9c2-3089300ef0c8";
      "kcminputrc"."Libinput/1267/12342/DELL07B4:00 04F3:3036 Mouse"."PointerAcceleration".value = 0.000;
      "kcminputrc"."Libinput/1267/12342/DELL07B4:00 04F3:3036 Mouse"."PointerAccelerationProfile".value = 1;
      "kcminputrc"."Libinput/1267/12342/DELL07B4:00 04F3:3036 Mouse"."ScrollFactor".value = 0.5;
      "kcminputrc"."Mouse"."X11LibInputXAccelProfileFlat".value = true;
      "kcminputrc"."Mouse"."XLbInptNaturalScroll".value = false;
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid".value = "{4f473d05-8103-4f78-b1a4-febeb0e4b4bc}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid".value = "{c74c7173-788c-4e3c-bcb6-732ed68ffc87}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid".value = "{30baec5b-8dd6-43dd-ab4d-8508e3f800a7}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid".value = "{11f90e35-c0dc-4cb1-bc38-d2a08b580043}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid".value = "{f4e1d6d7-3a6d-4524-a4ea-9e48942aa19f}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid".value = "{c183d1aa-82bd-46ae-8f98-043c3d9fdb6b}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid".value = "{346468a4-d49e-4355-90d2-ca639f8d3a1d}";
      ...
      "kwinrc"."Desktops"."Id_1".value = "17c26276-c31c-4f94-bb35-e6ed4ea34ce7";
      ...
      "kwinrc"."Tiling/f913ce42-033e-544b-a3cf-ca374aff746b"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Xwayland"."Scale".value = 1;
      "plasma-localerc"."Formats"."LANG".value = "en_US.UTF-8";
      "plasma-localerc"."Formats"."LC_MEASUREMENT".value = "nl_NL.UTF-8";
      "plasma-localerc"."Formats"."LC_MONETARY".value = "nl_NL.UTF-8";
      "plasma-localerc"."Formats"."LC_NUMERIC".value = "nl_NL.UTF-8";
      "plasma-localerc"."Formats"."LC_PAPER".value = "nl_NL.UTF-8";
      "plasma-localerc"."Formats"."LC_TELEPHONE".value = "nl_NL.UTF-8";
      "plasma-localerc"."Formats"."LC_TIME".value = "nl_NL.UTF-8";
    };
  };
}
